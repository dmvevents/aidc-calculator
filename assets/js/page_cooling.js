...
(function () {
  ...
  A.SECTIONS.push({
    ...
    fields: [
      ...
      { key: "tower_cell_kw", label: "tower cell duty kW_th (F7b)", src: "dossiers", step: 250, min: 100, advanced: true },
      { key: "tower_range_k", label: "tower water range K (F7b)", src: "dossiers", step: 1, min: 1, advanced: true },
      { key: "tower_spare_cells", label: "spare tower cells (N+1)", src: "dossiers", step: 1, min: 0, advanced: true },
      { key: "tower_drift_pct", label: "drift % of recirc (F7b)", src: "dossiers", step: 0.001, min: 0, advanced: true },
