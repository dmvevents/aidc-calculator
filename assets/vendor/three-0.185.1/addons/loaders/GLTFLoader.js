...
class GLTFLoader extends Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			// Example  path = '<your-server>/', url = 'assets/models/model.gltf'
			// resourcePath = '<your-server>/assets/models/'
			// referenced resource 'model.bin' will be loaded from '<your-server>/assets/models/model.bin'
			// referenced resource '../textures/texture.png' will be loaded from '<your-server>/assets/textures/texture.png'
